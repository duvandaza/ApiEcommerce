...
namespace ApiEcommerce.Controllers.V1
{
    ...
    public class CategoriesController : ControllerBase
    {
        ...
        [Obsolete("Este metodo esta obsoleto. Usar GetCategoriesById de la version 2")]
        ...
        public IActionResult GetCategory(int id)
        {
            ...
            System.Console.WriteLine($"respuesta cop el ID: {id}");
            if (category == null)
            {
        ...
        public IActionResult CreateCategory([FromBody] CreateCategoryDto createCategoryDto)
        {
            ...
            {
                ModelState.AddModelError("CustomErro", "La categoria ya existe");
                return BadRequest(ModelState);
            }
            var category = _mapper.Map<Category>(createCategoryDto);
            if (!_categoryRepository.CreateCategory(category))
            {
                ModelState.AddModelError("CustomErro", $"Algo salio mal al guardar el registro {category.Name}");
        ...
        public IActionResult UpdateCategory(int id, [FromBody] CreateCategoryDto updateCategoryDto)
        {
            ...
            {
                ModelState.AddModelError("CustomErro", $"Algo salio mal al actualizar el registro {category.Name}");
                return StatusCode(500, ModelState);
            }
            return NoContent();
        }
        ...
        public IActionResult DeleteCategory(int id)
        {
            ...
            if (!_categoryRepository.DeteleCategory(category))
            {
                ModelState.AddModelError("CustomErro", $"Algo salio mal al eliminar la categoria {category.Name}");
                return StatusCode(500, ModelState);
            }
            return NoContent();
        }
