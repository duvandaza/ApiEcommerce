...
{
    public static void SeedData(AplicationDbContext appContext)
    {
        // Seeding de Roles
        ...
        appContext.Categories.AddRange(
            new Category { Name = "Ropa y accesorios", CreateonDate = DateTime.Now },
            new Category { Name = "Electrónicos", CreateonDate = DateTime.Now },
            new Category { Name = "Deportes", CreateonDate = DateTime.Now },
            new Category { Name = "Hogar", CreateonDate = DateTime.Now },
            new Category { Name = "Libros", CreateonDate = DateTime.Now }
        );
        }
